	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h1 class="m-0 font-weight-bold text-primary">Update Type </h1>
            ...
            <form class="user" action="" id="typeForm" method="PUT">
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user" name="name" value="{{ $type->name }}" id="nameType" >
                        <p></p>
                    </div>
                    <div class="col-sm-6">
                        <label for="nameType">Slug:</label>
                        <input type="text" class="form-control form-control-user" name="slug" value="{{ $type->slug }}" id="slugType" >
                        <p></p>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary btn-user btn-block">Update Type</button>
            </form>
        </div>
	</div>
...
<script>
    $(document).ready(function() {
        ...
        $("#typeForm").submit(function (event) {
            ...
            $.ajax({
                url: '{{ route('type.update',$type->id) }}', // Replace with your route
                type: 'put',
