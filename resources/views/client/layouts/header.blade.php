                                    ...
                                    <div class="site_account_panel_list">
                                        <div class="site_account_info">
                                            ...
                                            <div class="site_account_inner">
                                                <ul>
                                                    <li class="user-name"><span>{{Auth::check() ? Auth::user()->name : ''}}</span></li>
                                                    <li><a href="{{route('account.infor')}}">Tài khoản của tôi</a></li>
                                                    <li><a href="{{route('account.address')}}">Danh sách địa chỉ</a></li>
...
<script>
    $(document).ready(function() {
        $('.action_clicked').click(function() {
            $('.account-header').toggleClass('action-show'); // Add or remove 'hidden' class
        });
    });
</script>
<script>
