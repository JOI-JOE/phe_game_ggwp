                      ...
                      <div class="swatch  ">
                        ...
                        <div class="select-swap">  
                          @foreach ($product_variant as $product )
                            <div class="n-sd swatch-element" data-id='{{$product->id}}'>
                              <label>
                ...
                <div class="product-actions">
                  <div class="select-actions clearfix">
                    ...
                    <div class="addcart-area ">
                      <button type="button" id="add-to-cart" class=" add-to-cartProduct button dark btn-addtocart addtocart-modal"
                      name="add">
                        Thêm vào giỏ
                      </button>
                      <button type="button" id="buy-now" class="  button dark btn-buynow btnred addtocart-modal"
                      name="add">
                        Mua ngay
                      </button>
                    </div>
